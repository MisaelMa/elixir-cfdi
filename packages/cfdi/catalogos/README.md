...
> **Estos archivos son auto-generados por [`cfdi_catalogos_codegen`](../catalogos_codegen). NO EDITAR a mano.**

## Catálogos disponibles

| SimpleType SAT       | Módulo Elixir                        | Variante        | Átomos | Extras |
|----------------------|--------------------------------------|-----------------|--------|--------|
| `c_FormaPago`        | `Cfdi.Catalogos.FormaPago`           | `:with_atoms`   | Sí     |        |
| `c_MetodoPago`       | `Cfdi.Catalogos.MetodoPago`          | `:with_atoms`   | Sí     |        |
| `c_TipoDeComprobante`| `Cfdi.Catalogos.TipoComprobante`     | `:with_atoms`   | Sí     |        |
| `c_Impuesto`         | `Cfdi.Catalogos.Impuesto`            | `:with_atoms`   | Sí     |        |
| `c_UsoCFDI`          | `Cfdi.Catalogos.UsoCFDI`             | `:with_atoms`   | Sí     |        |
| `c_Exportacion`      | `Cfdi.Catalogos.Exportacion`         | `:with_atoms`   | Sí     |        |
| `c_Moneda`           | `Cfdi.Catalogos.Moneda`              | `:with_atoms`   | Sí     |        |
| `c_RegimenFiscal`    | `Cfdi.Catalogos.RegimenFiscal`       | `:regimen_fiscal`| No    | `persona_fisica`, `persona_moral`, `inicio_vigencia`, `fin_vigencia` |
| `c_Periodicidad`     | `Cfdi.Catalogos.Periodicidad`        | `:strings_only` | No     |        |
| `c_Meses`            | `Cfdi.Catalogos.Meses`               | `:strings_only` | No     |        |
| `c_TipoRelacion`     | `Cfdi.Catalogos.TipoRelacion`        | `:strings_only` | No     |        |
| `c_ObjetoImp`        | `Cfdi.Catalogos.ObjetoImp`           | `:strings_only` | No     |        |
| `c_TipoFactor`       | `Cfdi.Catalogos.TipoFactor`          | `:strings_only` | No     |        |
| `c_Pais`             | `Cfdi.Catalogos.Pais`                | `:strings_only` | No     |        |
| `c_Estado`           | `Cfdi.Catalogos.Estado`              | `:strings_only` | No     |        |
...
```elixir
alias Cfdi.Catalogos.{FormaPago, MetodoPago, RegimenFiscal, Pais, TipoFactor}
