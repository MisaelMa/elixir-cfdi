defmodule Cfdi.Catalogos.Codegen.AtomNamer do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> Cfdi.Catalogos.Codegen.AtomNamer.normalize("Efectivo")
      :efectivo

      iex> Cfdi.Catalogos.Codegen.AtomNamer.normalize("Cheque nominativo")
      :cheque_nominativo

      iex> Cfdi.Catalogos.Codegen.AtomNamer.normalize("Régimen Simplificado de Confianza")
