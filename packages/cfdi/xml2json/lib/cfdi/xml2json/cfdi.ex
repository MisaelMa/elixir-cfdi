defmodule Cfdi.Xml2Json.Cfdi do
  ...
  árbol use átomos:
      ...
      cfdi = Cfdi.Xml2Json.Cfdi.new(xml, keys: :atom)
  ...
  @spec new(String.t(), XmlToJson.opts()) :: t()
  def new(xml, opts \\ []) do
    keys = Keyword.get(opts, :keys, :string)
    json = XmlToJson.parse(xml, opts)
