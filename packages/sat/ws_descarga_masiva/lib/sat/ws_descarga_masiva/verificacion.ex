defmodule Sat.WsDescargaMasiva.Verificacion do
  @moduledoc """
  Servicio `VerificaSolicitudDescarga` del WS de Descarga Masiva.

  Endpoint: `https://cfdidescargamasiva.clouda.sat.gob.mx/VerificaSolicitudDescargaService.svc`.
  ...
  alias Sat.WsDescargaMasiva.Types.{Token, VerificacionResult}
