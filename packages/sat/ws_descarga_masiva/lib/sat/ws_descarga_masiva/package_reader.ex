defmodule Sat.WsDescargaMasiva.PackageReader do
  @moduledoc """
  Lectura de paquetes ZIP descargados del WS.
  ...
  XML/registro al consumidor, evitando que tenga que tocar el ZIP
  directamente.
  """

  alias Sat.WsDescargaMasiva.Types.Paquete
  ...
  como `:uuid`, `:rfc_emisor`, `:rfc_receptor`, `:fecha`, `:total`, etc.
