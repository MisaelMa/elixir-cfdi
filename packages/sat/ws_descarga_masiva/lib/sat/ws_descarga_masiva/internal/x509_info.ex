defmodule Sat.WsDescargaMasiva.Internal.X509Info do
  @moduledoc false
  # Helpers para extraer informacion del certificado en los formatos que el
  # WS de Descarga Masiva del SAT requiere dentro de los sobres SOAP.
  ...
  # Orden tipico esperado por los WS del SAT (hoja a raiz). Nos basamos en el
  # orden RDN inverso al ASN.1 estandar.
  ...
  # Escape minimo para RFC 2253 (comas, plus, quotes, slashes, igual).
